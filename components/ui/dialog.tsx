...
function DialogContent({
  ...
  const drawerClasses =
    "inset-x-0 bottom-0 max-h-[92dvh] w-full rounded-t-[28px] border-b-0 p-6 shadow-[0_-24px_90px_rgba(0,0,0,0.5)] sm:top-[50%] sm:left-[50%] sm:bottom-auto sm:max-w-[calc(100%-2rem)] sm:translate-x-[-50%] sm:translate-y-[-50%] sm:rounded-xl sm:border sm:p-6 sm:shadow-[0_24px_90px_rgba(0,0,0,0.48)] sm:max-w-lg";
  const centerClasses =
    "top-[50%] left-[50%] max-h-[88dvh] w-[calc(100vw-1.5rem)] max-w-lg translate-x-[-50%] translate-y-[-50%] rounded-[28px] p-6 shadow-[0_24px_90px_rgba(0,0,0,0.5)]";
  ...
  return (
    <DialogPortal data-slot="dialog-portal" forceMount={forceMount}>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed z-50 grid gap-4 overflow-hidden border border-border/80 bg-background",
